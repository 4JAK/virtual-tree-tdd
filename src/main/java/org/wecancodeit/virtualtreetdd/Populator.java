...
public class Populator implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Bean tddQuestion1 = beanRepo.save(new Bean(clusterTdd, lessonRepo.save(new Lesson(getLesson1Tdd(), null)), 1,
				QuestionType.MultipleChoice, getQuestion1Tdd(), getCorrectAnswer1Tdd(), getAnswersFor1Tdd()));
		Bean tddQuestion2 = beanRepo.save(new Bean(clusterTdd, lessonRepo.save(new Lesson(getLesson2Tdd(), null)), 2,
				QuestionType.MultipleChoice, getQuestion2Tdd(), getCorrectAnswer2Tdd(), getAnswersFor2Tdd()));
		Bean tddQuestion3 = beanRepo.save(new Bean(clusterTdd, lessonRepo.save(new Lesson(getLesson3Tdd(), null)), 3,
				QuestionType.FillInTheBlanks, getQuestion3Tdd(), getCorrectAnswer3Tdd(), getAnswersFor3Tdd()));
		Bean tddQuestion4 = beanRepo.save(new Bean(clusterTdd, lessonRepo.save(new Lesson(getLesson4Tdd(), null)), 4,
				QuestionType.FillInTheBlanks, getQuestion4Tdd(), getCorrectAnswer4Tdd(), getAnswersFor4Tdd()));
		Bean tddQuestion5 = beanRepo.save(new Bean(clusterTdd, lessonRepo.save(new Lesson(getLesson5Tdd(), null)), 5,
		...
		// JUnit Questions
		Bean jUnitQ1 = beanRepo.save(new Bean(clusterJUnit,
				lessonRepo.save(new Lesson(getLesson1JUnit(), "/images/Test_1_Error_Display.png")), 6,
				QuestionType.MultipleChoice, getLesson1Question1JUnit(), getCorrectAnswerLesson1Answer1JUnit(),
				getAnswersForLesson1Answer1JUnit()));
		Bean jUnitQ2 = beanRepo.save(new Bean(clusterJUnit,
				lessonRepo.save(new Lesson(getLesson1JUnit(), "/images/Test_1_Error_Display.png")), 7,
				QuestionType.TrueOrFalse, getLesson1Question2JUnit(), getCorrectAnswerLesson1Answer2JUnit(),
				getAnswersForLesson1Answer2JUnit()));
		Bean jUnitQ3 = beanRepo.save(new Bean(clusterJUnit,
				lessonRepo.save(new Lesson(getLesson1JUnit(), "/images/Test_1_Error_Display.png")), 8,
				QuestionType.FillInTheBlanks, getLesson1Question3JUnit(), getCorrectAnswerLesson1Answer3JUnit(),
				getAnswersForLesson1Answer3JUnit()));
		Bean jUnitQ4 = beanRepo.save(new Bean(clusterJUnit,
				lessonRepo.save(new Lesson(getLesson1JUnit(), "/images/Test_1_Error_Display.png")), 9,
				QuestionType.FillInTheBlanks, getLesson1Question4JUnit(), getCorrectAnswerLesson1Answer4JUnit(),
				getAnswersForLesson1Answer4JUnit()));
		Bean jUnitQ5 = beanRepo.save(new Bean(clusterJUnit,
				lessonRepo.save(new Lesson(getLesson1JUnit(), "/images/Test_1_Error_Display.png")), 10,
				QuestionType.TrueOrFalse, getLesson1Question5JUnit(), getCorrectAnswerLesson1Answer5JUnit(),
				getAnswersForLesson1Answer5JUnit()));

		// This bean shows a passing 1st test
		Bean jUnitLesson02bean01 = beanRepo
				.save(new Bean(clusterJUnit, lessonRepo.save(new Lesson(getLesson2JUnit(), "/images/Test_1_Pass.png")),
						11, QuestionType.TrueOrFalse, getLesson1Question6JUnit(), // duplicate
						getCorrectAnswerLesson1Answer6JUnit(), getAnswersForLesson1Answer6JUnit()));
...
//    new Bean(cluster, lesson, questionNum, type, question, correctAnswer, answers)
		...
		Bean jUnitHamcrestQ1 = beanRepo.save(new Bean(clusterHamcrestJUnit,
				lessonRepo.save(new Lesson(getLesson1JUnitHamcrest(), "/images/Test_2_Requirements.png")), 12,
				QuestionType.MultipleChoice, getLesson1Question1JUnitHamcrest(),
				getCorrectAnswerLesson1Answer1JUnitHamcrest(), getAnswersForLesson1Answer1JUnitHamcrest()));
		Bean jUnitHamcrestQ2 = beanRepo.save(new Bean(clusterHamcrestJUnit,
				lessonRepo.save(new Lesson(getLesson2JUnitHamcrest(), "/images/Test_2_Requirements.png")), 13,
				QuestionType.TrueOrFalse, getLesson2Question1JUnitHamcrest(),
				getCorrectAnswerLesson2Answer1JUnitHamcrest(), getAnswersForLesson2Answer1JUnitHamcrest()));
		Bean jUnitHamcrestQ3 = beanRepo.save(new Bean(clusterHamcrestJUnit,
				lessonRepo.save(new Lesson(getLesson2JUnitHamcrest(), "/images/Test_2_Requirements.png")), 14,
				QuestionType.TrueOrFalse, getLesson2Question2JUnitHamcrest(),
				getCorrectAnswerLesson2Answer3JUnitHamcrest(), getAnswersForLesson2Answer2JUnitHamcrest()));
		Bean jUnitHamcrestQ4 = beanRepo.save(new Bean(clusterHamcrestJUnit,
				lessonRepo.save(new Lesson(getLesson2JUnitHamcrest(), "/images/Test_2_Requirements.png")), 15,
				QuestionType.MultipleChoice, getLesson2Question3JUnitHamcrest(),
				getCorrectAnswerLesson2Answer3JUnitHamcrest(), getAnswersForLesson2Answer3JUnitHamcrest()));
	...
	public String getLesson1Tdd() {
		return "<h2>Lesson 1</h2>"
				...
				+ "</ol>" + "<h3>3 A&#39;s of TDD are:</h3>" + "<ol>" + "<li>1. Arrange</li>" + "<li>2. Act</li>"
				+ "<li>3. Assert</li>" + "</ol>" + "";
	}

	public String getLesson2Tdd() {
		return "<h2>Lesson 2</h2>" + "<h3>Why do we use TDD?</h3>"
	...
	public String getLesson3Tdd() {
		return "<h2>Lesson 3</h2>"
				...
				+ "<p><span class='purple'>public class</span> ArrangeExample{" + "<br />" + "<br />" + "<pre>"
				+ "<span class='bold'>	@Test</span>" + "<br />"
				+ "<span class='purple'>	public void</span> wateringShouldGiveGrowthToYourTree()  {" + "<br />"
				+ "<br />" + "<span class='bold'>		// arrange</span>" + "<br />"
				+ "   		int currentGrowth = 10;" + "<br />" + "   		int water = 1;" + "<br />"
				+ "   		int expectedGrowthAfterWatering = 11;" + "<br />"
				+ "    		VirtualTree testTree= new VirtualTree(\"testTree\", currentGrowth);" + "<br />" + "<br />"
				+ "<span class='bold'>		//act</span>" + "<br />" + "<br />"
				+ "<span class='bold'>		//assert</span>" + "<br />" + "	}" + "</pre>" + " } </p>" + "";
	}
	...
	public String getLesson4Tdd() {
		return "<h2>Lesson 4</h2>"
				...
				+ "<br />" + "<p><span class='purple'>public class</span> ActExample" + "<br />" + "<br />" + "<pre>"
				+ "<span class='bold'>	@Test</span>" + "<br />"
				+ "<span class='purple'>	public void</span> wateringShouldGiveGrowthToVirtualTree()  {" + "<br />"
				+ "<br />" + "<span class='bold'>		// arrange</span>" + "<br />" + "		int currentGrowth = 10;"
				+ "<br />" + "		int waterAmount = 1;" + "<br />" + "		int expectedGrowthAfterWatering = 11;"
				+ "<br />" + "		VirtualTree testTree= new VirtualTree(\"testTree\", currentGrowth);" + "<br />"
				+ "<br />" + "<span class='bold'>		//act</span>" + "<br />" + "		testTree.water(waterAmount)"
				+ "<br />" + "		Int actual  = testTree.getGrowth();" + "<br />" + "<br />"
				+ "<span class='bold'>		//assert</span>" + "<br />" + "		}" + "</pre>" + "	} </p>" + "";
	}
	...
	public String getLesson5Tdd() {
		return "<h2>Lesson 5</h2>"
				...
				+ "<br />" + "<br />" + "<p><span class='purple'>public class</span> assertExample{" + "<br />"
				+ "<br />" + "<pre>" + "	<span class='bold'>@Test</span>" + "<br />"
				+ "	<span class='purple'>public void</span> wateringShouldGiveGrowthToYourTree()  {" + "<br />"
				+ "<br />" + "		<span class='bold'>//arrange</span>" + "<br />" + "		int currentGrowth = 10;"
				+ "<br />" + "		int waterAmount = 1;" + "<br />" + "		int expectedGrowthAfterWatering = 11;"
				+ "<br />" + "		VirtualTree testTree= new VirtualTree(\"testTree\", currentGrowth);" + "<br />"
				+ "<br />" + "		<span class='bold'>//act</span>" + "<br />" + "		testTree.water(waterAmount);"
				+ "<br />" + "		Int actual  = testTree.getGrowth();" + "<br />" + "<br />"
				+ "		<span class='bold'>//assert</span>" + "<br />"
				+ "		assertThat(actual, is(equalTo(expectedGrowthAfterWatering)));" + "<br />" + "		}"
				+ "</pre>" + "	} </p>" + "";
	}
...
//  }
	...
	public String getLesson1Question3JUnit() {
		return "_____" + "<br />" + "<pre>"
				+ "<span class='purple'>public void</span> shouldBeAbleToInstantiateClass(){" + "<br />" + "<br />"
				+ "	Branch branch = new Branch();" + "<br />" + "<br />" + "	assertNotNull(branch);" + "<br />" + "}"
				+ "</pre>" + "";
	}

	public String getLesson1Question4JUnit() {
		return "<pre>" + "<span class='bold'>@Test</span>" + "<br />"
				+ "<span class='purple'>public void</span> shouldBeAbleToInstantiateClass(){\n" + "<br />" + "<br />"
				+ "	Cluster cluster = new Cluster()" + "<br />" + "<br />" + "	______NotNull(cluster);" + "<br />"
				+ "}" + "</pre>" + "";
	}
	...
	public Collection<String> getAnswersForLesson2Answer4JUnitHamcrest() {
		...
		String answer2 = "Hamcrest matcher methods are used in conjunction with JUnit testing to make more expressive statements.";
