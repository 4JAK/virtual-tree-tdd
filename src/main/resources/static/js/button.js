...
function checkRadio(event) {
  ...
  enableSubmitButtonOnRadioSelect();
}
...
function enableSubmitButtonOnRadioSelect() {
  ...
  if (document.getElementById('selectedAnswer')) {
    ...
    document.getElementById('submitAnswer').classList.add('enabledSubmitButton');
  }
}
    ...
    */
    if (this.status === 200 && this.readyState === 4) {
      ...
      if (answer === true) {
        ...
        document.getElementById('submitAnswer').classList.toggle('enabledSubmitButton');
